    ...
    return (
      <div className="flex-parent border-blue">
        <div className="flex-child border-green">
          <h4>Introduction</h4>
          <p>These borders are displaying how css flex works. The blue border is a flex-parent which contains two
            flex-children.
            The parent sets direction (row) and alignment (space-between) for its children. The children sets its own
